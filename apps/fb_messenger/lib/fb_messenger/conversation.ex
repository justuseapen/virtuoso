defmodule FbMessenger.Conversation do
  @moduledoc """
  ...
  alias FbMessenger.Conversation.Supervisor
  alias FbMessenger.Executive

  defmodule State do
    @moduledoc """
    Struct for Conversation state
    """
    @environment Application.get_env(:fb_messenger, :environment)
  ...
  def pid(sender_id) do
    {:via, Registry, {FbMessenger.Conversation.Registry, sender_id}}
  end
  ...
  def ensure_process(sender_id) do
    case Registry.whereis_name({FbMessenger.Conversation.Registry, sender_id}) do
